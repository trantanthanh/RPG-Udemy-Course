...
public class CloneSkillController : MonoBehaviour
{
    ...
    private void AttackTrigger()
    {
        ...
        hasEnemy = PlayerManager.Instance.player.DoDamageEnemiesInCircle(attackCheck.position + offsetPos, attackRadius, false,  PlayerManager.Instance.player.skills.clone.GetPercentMirageDamage(), transform);
